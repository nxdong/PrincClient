...
UINT GetHostRemark(LPCTSTR lpServiceName, char* lpBuffer, UINT uSize)
{
	...
	ReadRegEx(HKEY_LOCAL_MACHINE, strSubKey, _T("Host"), REG_SZ, (char *)lpBuffer, NULL, uSize, 0);

	if (lstrlenA(lpBuffer) == 0)
